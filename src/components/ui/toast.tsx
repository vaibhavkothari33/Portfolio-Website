...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-24 right-4 z-[10050] flex max-h-screen w-full max-w-[380px] flex-col gap-2 p-0 sm:bottom-24 sm:right-6",
      className,
    )}
    {...props}
  />
...
const toastVariants = cva(
  [
    ...
    "rounded-xl border p-4 pr-10 shadow-[0_12px_40px_rgba(0,0,0,0.45)] backdrop-blur-xl",
    "transition-all",
